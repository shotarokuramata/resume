...
カスタマーサポート分野の負を解消すると同時に、技術の力で資産化するという取り組みに魅力を感じました。

私見ですがコールセンターまでわざわざ連絡がある顧客は次の理由のため貴重です。

- クレームや不満を含む場合、うまく対応できればそういった顧客は転じてお得意様になるケースが多い

- 同様の不満が他の顧客にあり、わざわざ問い合わせず黙ってサービスから離脱するようなケースがある

RightSupportを用いて単純な問い合わせの自己解決を促した上で、RightConnectを用いた適切な顧客対応を行なった先には、
効率化に加えて、人と人との繋がりにより価値を生み出すような作用が生まれるような気がしており、可能性を感じています。

### 認知の拡大が世界平和につながると考えているから

転職ドラフトの欄に世界平和と書いているのですが、これは認知の拡大によって実現されると考えています。

カスタマーサポートの最も辛いことの一つに、自らがサポートすべき存在である筈のカスタマーと敵対してしまうことが多いという点があるかと思います。

貴社のサービスを通じて、カスタマーとサポートの向きが揃いやすくすることで、世の中を平和に近づけるような取り組みをしたいと考えております。
