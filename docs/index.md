...
世界平和のために仕事をしたいと考えています。

旅行は世界平和に繋がると思っており、技術を使って旅行者数を増やすことに取り組みたいと考えております。

その為に、御社では次のようなことを実現したいと考えています。
...
そのため、御社の検索テクノロジーを突き詰めて Postgres の独自の拡張を開発されていたり、社内フレームワークの継続的な改善をしたりされている点に魅力を感じました。

前職で得たエンジニアとしての経験や旅行というドメインへの思いを活かし、より高い水準が必要/要求される環境で旅行の仕事がしたいと考えております。

また、事業ドメインを同じくするビジネスサイドの方々と協力しながら業務にあたった経験については、御社でも活かせるポイントかなと考えております。
