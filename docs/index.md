...
旅行は世界平和に繋がると思っており、技術を使って旅行者数を増やすことに取り組んで行きたいと考えております。

その為に、御社で以下のようなことを実現したいと考えています。

### プロダクトを突き詰めてで旅行に出発するまでの障壁を取り除く

旅行者が旅行に出発するまでの障壁を取り除きたいと、エンジニアになる前から思っておりました。

エンジニアとしては応答性やUIについて突き詰めたものを作ることで、旅行者に良い体験をして貰いたいと考えております。

そのため、御社の検索テクノロジーを突き詰めてPostgresの独自の拡張を開発されていたり、社内フレームワークの継続的な改善を行っている点に魅力を感じました。
